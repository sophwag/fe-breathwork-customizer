      ...
      <section>
        ...
        <div className="row align-items-center g-lg-5 py-5">
          <div className="col-lg-5 text-center text-lg-start">
            ...
            <p className="col-lg-10 fs-4">Custom breathwork sessions for people who don't like counting or looking at screens. Input your preferences and get customized audio to guide you through a breathing session. </p>
          </div>
          <div className="col-md-10 mx-auto col-lg-6 border rounded-4 bg-light shadow-lg">  
