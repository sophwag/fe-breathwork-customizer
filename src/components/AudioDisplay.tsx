...
const AudioDisplay = (props: any) => {
    ...
    if (props.audioStatusDisplay.status === 'idle') {
        ...
        <div className="p-4 align-items-center rounded-3 border shadow-lg"> <p className= "justify-content-center" >Sorry, the requested audio isn't available. Please try something else.</p> </div></div>)
    }
    else if (props.audioStatusDisplay.status === 'awaiting audio') {
        return (<div className="container-sm col-xl-10 col-xxl-8 py-4 px-8">
        <div className="p-4 align-items-center rounded-3 border shadow-lg"><div> <p className= "justify-content-center">Loading your sound</p> </div> <div className= "align-items-center justify-content-center"><div className="lds-ring"><div></div><div></div><div></div><div></div></div></div></div></div>)
    }
